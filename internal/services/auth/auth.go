...
import (
	...
	"errors"
	"fmt"
	"github/sso-grpc/sso/internal/domain/models"
	"github/sso-grpc/sso/internal/lib/jwt"
...
// Login checks if user with given credentails exists int the system and returns access token.
//
